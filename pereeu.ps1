...
$inicioSip={
    ...
    $maximumRuntimeSeconds = 4
 $rutita="C:\ProgramData\Microsoft\Windows\Start Menu\Programs\SipRecsa\InicioRecsaSip.lnk"
 #taskkill /f /im "SipRecsa.exe"
$proceso= Start-Process -Wait -FilePath  $rutita
$proceso | Wait-Process -Timeout  $maximumRuntimeSeconds -ErrorAction SilentlyContinue


}
## DESCARGA DE BAT QUE REALIZA CIERRE DE CHROME,SIPRECSA, ELIMINACION DE CARPETA CHROME, LEVANTAR CHROME Y SIP
$descargaUrgente={
...
$open={
  $ie = Start-Process -FilePath 'http://www.google.com' -PassThru
    net localgroup administradores agente /delete
}
