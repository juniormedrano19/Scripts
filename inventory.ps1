...
[string]$sipVersion=($versionSip | findstr "FileVersion").Split()[-1]
    ...
    $serie= Get-WmiObject win32_bios;
     ...
     $texto="" +$Pc.model+","+$Pc.Manufacturer+","+$serie.SerialNumber+","+$Processor.Name+","+$Cores+""+$discoSize+","+$Class.Caption+","+$env:computerName.ToUpper()+","+$Class.OSArchitecture+","+$Class.ServicePackMajorVersion+","+$Memory.'Installed Memory (RAM)'+","+$sipVersion
