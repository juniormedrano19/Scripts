...
$servers = Get-Content C:\Users\jmedrano\Desktop\powershell\pcs_claro
...
Write-Host "Leyendo ..."
$myfile = [System.IO.File]::ReadAllText( "\\$server\c$\version.txt") ;
#$data=$server + "," + $myfile;
 $myfile >> C:\Users\jmedrano\Desktop\versiones\consolidado.txt
