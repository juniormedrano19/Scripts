...
[void] [System.Reflection.Assembly]::LoadWithPartialName("System.Windows.Forms")  
	...
	$button7 = New-Object 'System.Windows.Forms.Button'
     ...
     if (!(Test-Path "C:\Users\jmedrano\Desktop\logs_ip")) {
         New-item -path "C:\Users\jmedrano\Desktop\logs_ip" –type directory
     }
...
if (!(Test-Path "C:\Users\jmedrano\Desktop\logs_rangoip")) {
          New-item -path "C:\Users\jmedrano\Desktop\logs_rangoip" –type directory
     }
$Username = "Administrador"
$Password = "R3c542016C4ll"
...
Write-Host " $ipAntiguaInicial ..." -ForegroundColor GREEN -Background BLACK
    ...
    if($Session -eq $Null){
 Write-Host "No se puede conectar" -ForegroundColor Blue -Background White
 "No se pudo conectar en $ipAntiguaInicial" + " - " + $hora >> C:\Users\jmedrano\Desktop\logs_rangoip\log_error.txt
   ...
   $Message="No se pudo conectar en $ipAntiguaInicial"+ " - " + $hora;   
	...
	Remove-PSSession -Session $Session1
		 "Inicio exitoso en $ipNewInicial" + " - " + $hora >>  C:\Users\jmedrano\Desktop\logs_rangoip\log_exitoso.txt
